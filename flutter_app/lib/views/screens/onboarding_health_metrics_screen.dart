...
import 'package:flutter_app/views/widgets/goal_button.dart';
                        ...
                        children: [
                          Expanded(
                            child: GoalButton(
                              ...
                              isSelected:
                                  onboardingViewModel.fitnessGoal ==
                                  FitnessGoal.balancedDiet,
                              accentColor: AppColors.secondaryGreen.withOpacity(
                                0.9,
                              ),
                              onTap: () {
                                onboardingViewModel.setFitnessGoal(
                                  FitnessGoal.balancedDiet,
                                );
                              },
                            ),
      ...
      child: ClipRRect(
        ...
        child: CupertinoButton(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Icon(icon, color: AppColors.secondaryBlackTextColor, size: 24),
                ...
                const Spacer(),
                RichText(text: TextSpan(children: _buildValueTextSpans(value))),
                const Icon(
                  Icons.chevron_right,
