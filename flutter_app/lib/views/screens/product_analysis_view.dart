...
import 'package:flutter_app/core/constants/nutrient_insights.dart';
import 'package:flutter_app/theme/app_colors.dart';
import 'package:flutter_app/theme/app_text_styles.dart';
...
import 'package:flutter_app/views/screens/ask_ai_view.dart';
import 'package:flutter_app/views/widgets/ask_ai_widget.dart';
import 'package:flutter_app/views/widgets/nutrient_balance_card.dart';
import 'package:flutter_app/views/widgets/nutrient_info_shimmer.dart';
import 'package:flutter_app/views/widgets/nutrient_tile.dart';
import 'package:flutter_app/views/widgets/product_image_capture_buttons.dart';
...
class _ProductAnalysisViewState extends State<ProductAnalysisView> {
      ...
      slivers: [
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            title: Text('Scan Label', style: AppTextStyles.heading2BoldClose),
            collapseMode: CollapseMode.pin,
          ),
        ),
        SliverToBoxAdapter(
          child: Consumer3<UiViewModel, ProductAnalysisViewModel, DailyIntakeViewModel>(
            builder: (context, uiProvider, productAnalysisProvider, dailyIntakeProvider, _) {
              return Column(
                            ...
                            onPressed: () {
                              if (uiProvider.sliderValue == 0) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text(
                                      'Please select your consumption to continue',
                                    ), // Updated message
                                  ),
                                );
                              } else {
  ...
  void _handleImageCapture(ImageSource source) async {
    ...
    final productAnalysisProvider = Provider.of<ProductAnalysisViewModel>(
      context,
      listen: false,
    );
