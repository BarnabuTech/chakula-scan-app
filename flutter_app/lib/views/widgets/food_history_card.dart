...
import 'package:flutter_app/views/widgets/food_history_item_card.dart';
import 'package:flutter_app/views/widgets/food_input_form.dart';
          ...
          children: [
            Consumer<DailyIntakeViewModel>(
              builder: (context, viewModel, child) {
                final todayItems =
                    viewModel.foodHistory
                        .where(
                          (item) =>
                              isSameDay(item.dateTime, widget.selectedDate),
                        )
                        .toList()
                      ..sort(
