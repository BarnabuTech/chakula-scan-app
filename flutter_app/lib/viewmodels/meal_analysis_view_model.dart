...
import 'package:flutter_app/core/constants/dv_values.dart';
import 'package:flutter_app/core/constants/nutrient_insights.dart';
import 'package:flutter_app/main.dart';
import 'package:flutter_app/models/food_item.dart';
import 'package:flutter_app/repositories/spring_backend_repository.dart';
import 'package:flutter_app/viewmodels/base_view_model.dart';
...
class MealAnalysisViewModel extends BaseViewModel {
  ...
  final List<Map<String, dynamic>> _nutrientInfo = [];
  ...
  void calculateNutrientInfo(Map<String, dynamic> totalScannedPlateNutrients) {
    ...
    totalScannedPlateNutrients.forEach((key, value) {
